...
// * RestAssured.
// * Tests atomic checkout transaction combining booking confirmation and
// payment
// * initiation.
...
// @DisplayName("Should successfully checkout with locked seats and create
// payment")
// void testAtomicCheckout_Success() {
// // First lock seats
// var lockRequest = new
// com.api.moviebooking.models.dtos.booking.LockSeatsRequest(
...
// promotionRepo.findById(activePromotion.getId()).orElseThrow();
...
// var bookings = bookingRepo.findByUserId(testUser.getId());
// assertTrue(bookings.isEmpty(), "No booking should be created on payment
// failure");
