...
/**
 * Integration tests for UserController using Testcontainers and RestAssured.
...
class UserIntegrationTest {
    ...
    void testLogout_InvalidToken() {
        ...
        given()
                ...
                .post("/users/logout")
                .then()
                .statusCode(HttpStatus.OK.value()); // Service catches exception in try-catch, returns void (200 OK)
    }
    ...
    void testLogout_MissingParameter() {
        given()
                ...
                .post("/users/logout")
                .then()
                .statusCode(HttpStatus.INTERNAL_SERVER_ERROR.value()); // Required @RequestParam missing -> Exception ->
                                                                       // 500
    }
    ...
    void testRefreshToken_InvalidToken() {
        ...
        given()
                ...
                .post("/users/refresh-token")
                .then()
                .statusCode(HttpStatus.INTERNAL_SERVER_ERROR.value()); // IllegalArgumentException from service -> 500
    }
    ...
    void testRefreshToken_MalformedToken() {
        ...
        given()
                ...
                .post("/users/refresh-token")
                .then()
                .statusCode(HttpStatus.INTERNAL_SERVER_ERROR.value()); // JWT parsing exception -> 500
    }
}
